 ...
 * и добавляют в этот массив новое имя (без пути к файлу, только его имя; поэтому два разных файла 
 * с одним и тем же именем будут отождествлены), если ftw вызвала fn* не для директории, а для файла.
 *
