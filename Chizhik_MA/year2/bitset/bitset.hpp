	...
	public:
		...
		class Iterator {
			...
			public:
				...
				// Выполнение шага итератора (abs(step_) раз вперед или назад в зависимости от знака step_)
				// Если совершено меньше, чем step_ шагов, но граница множества уже достигнута, выполнение останавливается и не вызывает исключение
				int next_step();
