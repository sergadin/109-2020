/*
	...
	*
	* В результате работы программы на стандартный поток вывода будет напечатан список всех файлов и их размеры, ширина колонки с именами файлов равна Max_len
	* 
    * Метод:
