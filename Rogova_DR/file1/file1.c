...
Краткое описание дейсвия:

Проверяет, что ftw подала именно файл,
считывает в цикле строки из файла и выводит те, которые подходят под условие, для обхода дерева файлов, используется функция ftw из библиотеки <ftw.h>.
*/
